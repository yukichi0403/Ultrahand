...
from sklearn.metrics import roc_curve, confusion_matrix, ConfusionMatrixDisplay, precision_score, average_precision_score, auc, f1_score, mean_squared_error # Metrics and displays
